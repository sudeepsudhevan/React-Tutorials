      ...
      <Form method="POST">
        ...
        <div>
          ...
          <button disabled={isSubmitting}
            className="bg-yellow-400 uppercase font-semibold text-stone-800 px-4 py-3 inline-block tracking-wide 
            focus:outline-none focus:ring focus:ring-yellow-300 focus:bg-yellow-300 focus:ring-offset-2 rounded-full 
            hover:bg-yellow-300 transition-colors duration-300 disabled:cursor-not-allowed"
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone)) {
    errors.phone = 'Please give us a valid phone number, we might need to contact you';
  }
